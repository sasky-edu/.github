...
2. Avaa oppilaitoksen sähköpostista viesti, jossa sinut kutsutaan liittymään organisaatioon. Klikkaa viestissä olevaa **Join @sasky-edu** -nappia.
   ...
   <div style="text-align: center; margin: 1em 0;">
     <img src="assets/github-join-1.png" alt="Kutsu liittymään sasky-edu -organisaatioon" style="max-width: 500px">
   </div>
...
3. Hyväksy kutsu klikkaamalla **Authenticate to join** -nappia. 
   ...
   <div style="text-align: center; margin: 1em 0;">
     <img src="assets/github-join-2.png" alt="Liittymiskutsun hyväksyminen" style="max-width: 500px">
   </div>
